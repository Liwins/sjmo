package cn.riversky.adapter.e5.adapter;

import cn.riversky.adapter.e5.dao.LogDbOperateApi;
import cn.riversky.adapter.e5.dao.impl.LogFileOperate;
import cn.riversky.adapter.e5.domain.LogModel;

import java.util.List;

/**
 * 如果仅仅需要旧的代码对新的接口进行支持，那么只需要写一个适配器类，然后继承就的类，实现新的接口，新的接口就是需要适配的接口
 *
